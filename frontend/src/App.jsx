...
const NAV = [
  ["dashboard", "Dashboard"], ["graph", "Knowledge Graph"], ["connectors", "Connectors"],
  ["assistant", "Assistant"], ["documents", "Documents"], ["settings", "Settings"],
];
const TITLES = Object.fromEntries(NAV);
const VIEW = { dashboard: Dashboard, graph: Graph, connectors: Connectors, assistant: Assistant, documents: Documents, settings: Settings };
